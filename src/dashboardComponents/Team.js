...
const Leaders = () => {
  ...
  return (
    <>
      ...
      <div className="overflow-x-auto bg-[#38434e] pb-10 min-h-screen lg:ml-56 px-2 lg:px-10" id='contact-section'>
        <div className="flex items-left px-4 lg:px-7 pt-14 pb-8">
          {user[0]?.isAdmin ? (
            <div className="space-x-8">
              <button className="font-serif bg-[#072081] hover:bg-transparent border border-gray-800 hover:text-black hover:bg-white font-medium rounded-lg text-base px-5 py-2.5 mt-8 text-center mr-3 md:mr-0 cursor-pointer" onClick={removeModel}>Team +</button>
            </div>
          ) : ""}
        </div>
        <div className="md:px-22">
          <div className="bg-white shadow-lg px-5 py-8 rounded-md w-full lg:w-full ">
            <div className="flex items-center justify-between pb-6">
              <div>
                <h2 className="font-sans text-xl text-black font-semibold px-1 hover:underline">Available Drivers</h2>
              </div>
            </div>
            <div>
