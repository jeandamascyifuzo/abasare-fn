            ...
            <div className="px-3 flex items-center w-full h-full justify-between">
                ...
                <div className={!open ? 'hidden' : 'w-58 mt-48 rounded-lg shadow border absolute bg-[#191919] justify-end right-0'}>
                    <ul className="space-y-3">
                        ...
                        <li className="font-medium">
                            <NavLink to="change/password" className="flex text-white items-center transform transition-colors duration-200 border-r-4 border-transparent hover:border-indigo-700">
                                <div className="mr-3">
