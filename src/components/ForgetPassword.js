            ...
            <div className="container mx-auto">
                ...
                <div className="flex justify-center items-center h-screen px-6">
                    <div className="w-full xl:w-3/4 lg:w-11/12 flex">
                        ...
                        >
                            <img src='https://media.istockphoto.com/photos/man-in-the-dark-with-his-hands-on-his-head-who-has-forgotten-a-picture-id1398853737?b=1&k=20&m=1398853737&s=170667a&w=0&h=O6dYubYKsmICDjMP1r5ZawG9hG3kiXFglLVGLJf5HTk='
                                className='h-full'
                                alt='images' />
                        </div>
